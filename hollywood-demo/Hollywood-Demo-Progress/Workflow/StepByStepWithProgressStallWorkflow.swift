...
struct StepByStepWithProgressStallWorkflow: CompositeWorkflowAction {
    ...
    func execute() async throws -> String {
        ...
        // This action causes the user to experience a "stall" in progress reporting. Once this action completes,
        // progress picks up again.
        let stall = try await execute(NonProgressReportingGenerateNumericString(iterations: 3, delay: .seconds(1)))
        ...
        return resultA + resultB + resultC + resultD + stall
    }
}
